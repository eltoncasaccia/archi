  ...
  return (
    <div className="oa-root" style={{
      ...
      <div style={{
        ...
        <div style={{ maxWidth: 380 }}>
          ...
          <p style={{ margin: "0 0 32px", color: "var(--muted)", fontSize: 14 }}>
            Apenas administradores cadastrados.
          </p>
        ...
        <div style={{ fontSize: 12, color: "var(--muted)" }}>
          Cadastros via Supabase Dashboard. Sem auto-cadastro.
        </div>
      </div>
      ...
      <div style={{
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: 18 }}>
          {[
            { label: "API Discovery",   value: "ok",  meta: "p99 · 184ms" },
            { label: "Pipeline Workers", value: "ok",  meta: "3 ativos" },
            { label: "Geração DOCX/PDF", value: "ok",  meta: "fila · 0" },
